...
//------------------------------------------------------------------
void Murmure::setMode(particleMode newMode)
{
     mode = newMode;
}
//------------------------------------------------------------------
void Murmure::setVelFactor(float factor)
{
    velFactor = factor;
}
//------------------------------------------------------------------
void Murmure::setFrcFactor(float factor){
    frcFactor = factor;
    
}
//------------------------------------------------------------------

void Murmure::setDragFactor(float factor){
    dragFactor = factor;
...
void Murmure::setAttractPoints( vector <ofPoint> * attract ){
...
void Murmure::update(){
    ...
    if( mode == PARTICLE_MODE_ATTRACT ){
        ...
        vel*= drag-dragFactor*0.01; //apply drag
        vel+= frc /frcFactor+0.0001; //apply force
    }
...
//void Murmure::setup_gui()
//{
//    string title = "murmure ";
//    title += std::to_string(index);
//    gui.setup();
//    gui.setName(title);
//    
//    string str_drag = "drag ";
//    str_drag += std::to_string(index);
//    gui.add(dragFactor.set(str_drag, 1, 0, 10));
//    gui.add(velFactor.set("velocity", 1, 0, 10));
//    gui.add(frcFactor.set("force", 4, 0, 10));
//    gui.add(unique_val_gui.set("unique", uniqueVal, -10000, 10000));
